...
var middlewareSecret = "51acdddb-9754-4718-8934-e2b313d30131";
//#endregion
...
var _page1 = () => import("./chunks/auth_CoxwJfJL.mjs");
var _page2 = () => import("./chunks/callback_DnXlX9-L.mjs");
...
var entrypoint_default = { async fetch(request) {
	...
	else if (url.searchParams.get("x_astro_path_token") === "51acdddb-9754-4718-8934-e2b313d30131") realPath = url.searchParams.get(ASTRO_PATH_PARAM);
